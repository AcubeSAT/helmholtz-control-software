...
def main():
        ...
        while True:
            ...
            for i in range(3):
                ...
                if coils[i].axis == 'y':
                    ...
                    elif pid_controllers[i].get_current_measured() < 0:
    ...
    # Magnetic Field X
    plt.subplot(3, 1, 1)
    plt.plot(timestamps, magnetic_field_value_array[:, 0] * 1e6, label='Magnetic Field X (\u03bcT)', color='r')
    ...
    # Magnetic Field Y
    plt.subplot(3, 1, 2)
    plt.plot(timestamps, magnetic_field_value_array[:, 1] * 1e6, label='Magnetic Field Y (\u03bcT)', color='g')
    ...
    # Magnetic Field Z
    plt.subplot(3, 1, 3)
    plt.plot(timestamps, magnetic_field_value_array[:, 2] * 1e6, label='Magnetic Field Z (\u03bcT)', color='b')
